    ...
    <section id="contactSection" className='contactSection'>
        ...
        <div className='contactDiv'>
            <div className='contactDivContent'>
                <img src="Portfolio/src/Imagens/gmail.svg" alt="Email" className='gmailImg'/>
                <p>schvuchov.k@gmail.com</p>
            </div>

            <div className='contactDivContent'>
                <a href="https://github.com/Schvuchov" className='gitImg'>
                ...
                <a href="https://github.com/Schvuchov">Github</a>
            </div>

            <div className='contactDivContent'>
                <a href="https://www.linkedin.com/in/barbara-schvuchov/" className='linkedinImg'>
                ...
                <a href="https://www.linkedin.com/in/barbara-schvuchov/">Linkedin</a>
            </div>
